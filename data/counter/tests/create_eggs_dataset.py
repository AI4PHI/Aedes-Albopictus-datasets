...
def create_eggs_dataset(input_path: str, output_dir: str = "./"):
    ...
    data_egg.to_pickle(f"{output_dir}/eggs_y_norm.pkl")
    ...
    data_egg_7days.to_pickle(f"{output_dir}/eggs_y_norm_7days.pkl")
    ...
    data_egg_14days.to_pickle(f"{output_dir}/eggs_y_norm_14days.pkl")
...
if __name__ == "__main__":
    create_eggs_dataset(
        input_path="../output_data/albopictus_with_climate_3m.pkl",
        output_dir="./"
    )